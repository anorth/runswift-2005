...
// Modified to c++ class by Derek Leung
...
// Get the current time and use it as the reference for later calls to 
// elapsed().
void Timer::start()
{
...
long Timer::elapsed()
{
   ...
   dsec = now.time - start_time.time;
   dms  = now.millitm - start_time.millitm;
