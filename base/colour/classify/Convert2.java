...
//    static final int PIC_HEIGHT = 144;
	...
	public static final int colors[] = {0, 1, 2, 3, 4, 5, 6, 7, 8};
	public static final int NO_COLOR = 9;

	public static boolean extention(String name,String ext)
	{

		int dot = name.lastIndexOf('.');

		return (name.substring(dot+1).toLowerCase().equals(ext.toLowerCase())) ;
