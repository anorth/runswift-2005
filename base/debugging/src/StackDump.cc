...
*/
//Kim: for some reason, the emon.log is improperly dumped, some thing like 
// [stack info]
//   area: ....
// [stack info]
//   area: ....
// [stack dump]
//   area: ....
//so i added some guard to be not vulnerable
...
StackDump::StackDump(istream& is) throw (StackAnalyserException)
{
    ...
    do {
        ...
        //cout << "-->" << buffer << endl;
    } while (strstr(buffer,"stack dump") == NULL);
