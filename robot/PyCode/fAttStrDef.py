...
# Attacker-Striker-Defender formation
# Attacker as usual. 
# Striker stays in the attacking half
# Defender stays in the defending half
...
# Determines who should be striker based on which non-attacking robot is 
        ...
        if Global.myLastRole == Constant.STRIKER\
            ...
            for i in Global.otherValidForwards: 
                ...
                if mate.isStriker()\
                    ...
                    if pForward.shouldIBreakStrikerSymmetry(i):
                        return False 
            else:
                return True
