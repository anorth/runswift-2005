...
#ifndef FieldDef_h_DEFINED
#define FieldDef_h_DEFINED
#if 1
#include "OsakaFieldDef.h"
#else
static const int LEFT = 1;
static const int RIGHT = 2;

// actual dimension of the field
static const int FIELD_WIDTH = 360; //was 290;
static const int FIELD_LENGTH = 540; //was 440;
static const int FIELD_DIAGONAL = 649; //was 527;
static const int WALL_THICKNESS = 0; //was 10;
static const int GOAL_WIDTH = 80; // was 60
...
// + 2*wall thickness
static const int GOALBOX_WIDTH = 130; //was 100;
static const int GOALBOX_DEPTH = 65; //was 50;
static const int CIRCLE_DIAMETER = 36; //was 30;
static const double LINE_WIDTH = 2.5;// was 2.4; // width of tape


// new constants for beacons of 2005 field
static const int BEACON_EDGE_LINE_OFFSET_X = 15;
static const int BEACON_BOTTOM_LINE_OFFSET_Y = 135;
...
static const int SIDE_FRINGE_WIDTH = 20;
static const int GOAL_FRINGE_WIDTH = 30;
